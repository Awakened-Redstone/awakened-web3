    ...
    <header class="site-header" role="presentation">
      ...
      <section ref="mobileMenu" class="mobile-menu">
        <div class="mobile-menu-wrapper">
          ...
          <!--<NuxtLink class="item" to="/something">
            ...
            <a href="https://github.com/Awakened-Redstone" target="_blank" class="item">
...
import HomeIcon from '~/assets/images/utils/redstone-simple.svg?inline'
import GithubIcon from '~/assets/images/utils/github.svg?inline'
import ModIcon from '~/assets/images/utils/fabric.svg?inline'
